...
use Shredio\TypeSchema\Types\ArrayKeyType;
...
final class ArrayKeyTypeTest extends TypeTestCase
{
	...
	{
		yield $this->typeToTest(new ArrayKeyType(), ['string']);
		yield 'string' => 'hello';
		yield 'empty string' => '';
		...
		yield $this->typeToTest(new ArrayKeyType(), ['string', 'int']);
		yield 'integer' => 123;
		yield 'zero' => 0;
	...
	{
		yield $this->typeToTest(new ArrayKeyType());
		yield 'float' => 45.67;
		yield 'NAN value' => NAN;
		yield 'INF value' => INF;
