...
final class ErrorReportConfigTest extends TestCase
{
	...
	public function testDefaultTypeSeparator(): void
	{
		$this->assertSame('|', (new ErrorReportConfig())->typeSeparator);
		$this->assertSame(', ', (new ErrorReportConfig(typeSeparator: ', '))->typeSeparator);
	}
